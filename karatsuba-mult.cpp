/*
 * Implement Karatsuba's algorithm to multiply two integers.
 *
 * Ref: https://www.coursera.org/learn/algorithms-divide-conquer/lecture/wKEYL/karatsuba-multiplication
 *
 * Cloned from: https://drawar.github.io/karatsuba-cpp/
 *
 * History:
 * 21.Jan.2022 - Started.
 */
...
string
subtract(string lhs, string rhs)
{
    int length = max(lhs.size(), rhs.size());
    int diff;
    string result;
